...
function setup_cluster {
	...
	do
	ssh -o 'StrictHostKeyChecking=no' "$master_node" "export GITHUB_TOKEN=$GITHUB_TOKEN && export CORTX_SCRIPTS_BRANCH=integration && /var/tmp/cortx-deploy-functions.sh --setup-master"
        done
