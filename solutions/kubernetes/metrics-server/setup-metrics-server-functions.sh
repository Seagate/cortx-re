...
function install_metricsserver() {
    ...
    kubectl apply -f "${CORTX_RE_REPO/github.com/raw.githubusercontent.com/}/$CORTX_RE_BRANCH/solutions/kubernetes/metrics-server/metric-server-components.yaml"
...
function install_k8dashboard() {
    ...
    kubectl apply -f "${CORTX_RE_REPO/github.com/raw.githubusercontent.com/}/$CORTX_RE_BRANCH/solutions/kubernetes/metrics-server/cluster_admin_svc_acnt.yaml"
