...
function install_k8dashboard() {
    ...
    kubectl apply -f https://raw.githubusercontent.com/${CORTX_RE_OWNER_REPO_NAME}/${CORTX_RE_BRANCH}/solutions/kubernetes/metrics-server/cluster_admin_svc_acnt.yaml
