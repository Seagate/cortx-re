...
function install_metricsserver() {
    ...
    # kubectl apply -f https://raw.githubusercontent.com/seagate/cortx-re/main/solutions/kubernetes/resources/metric-server-components.yaml
...
function install_k8dashboard() {
    ...
    # For Testing purpose: Fetching file from test repo, raised same file with the PR.
    # kubectl apply -f https://raw.githubusercontent.com/seagate/cortx-re/main/solutions/kubernetes/resources/cluster_admin_svc_acnt.yaml
