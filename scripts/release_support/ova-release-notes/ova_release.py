...
releases_url="http://ssc-nfs-cicd1.colo.seagate.com/releases/cortx/github/cortx-1.0/centos-7.8.2003/"
...
time.sleep(60)
with open('/root/git_build_checkin_stats/clone/git-build-checkin-report.md') as f:
    for line in f:
