        ...
        stage('Install Dependencies') {
            steps {
                ...
                sh label: 'Configure yum repository for cortx-py-utils', script: '''
                    ...
                    yum-config-manager --nogpgcheck --add-repo=http://cortx-storage.colo.seagate.com/releases/cortx/github/integration-custom-ci/$os_version/$release_tag/cortx_iso/
