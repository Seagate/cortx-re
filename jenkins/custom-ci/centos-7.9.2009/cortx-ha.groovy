...
EOF
                pip3 install -r https://raw.githubusercontent.com/Seagate/cortx-utils/$HA_BRANCH/py-utils/python_requirements.txt
                pip3 install -r https://raw.githubusercontent.com/Seagate/cortx-utils/$HA_BRANCH/py-utils/python_requirements.ext.txt
                rm -rf /etc/pip.conf
            '''        
            }
        }
