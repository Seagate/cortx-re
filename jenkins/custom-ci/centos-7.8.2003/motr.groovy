#!/usr/bin/env groovy
properties([[$class: 'ThrottleJobProperty', categories: [], limitOneJobWithMatchingParams: false, maxConcurrentPerNode: 5, maxConcurrentTotal: 5, paramsToUseForLimit: 'MOTR_BRANCH', throttleEnabled: true, throttleOption: 'project']])
