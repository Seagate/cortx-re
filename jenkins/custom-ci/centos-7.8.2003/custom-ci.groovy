	...
	stages {
		...
		stage ('Sign rpm') {
			steps {
				...
				checkout([$class: 'GitSCM', branches: [[name: 'single-iso-gpg']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'AuthorInChangelog']], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'cortx-admin-github', url: 'https://github.com/shailesh-vaidya/cortx-re']]])
