    ...
    stages {
        ...
        stage('Build') {
            steps {
                ...
                dir('cortx-re') {
                    checkout([$class: 'GitSCM', branches: [[name: '*/CORTX-32926']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'CloneOption', depth: 1, honorRefspec: true, noTags: true, reference: '', shallow: true], [$class: 'AuthorInChangelog']], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'cortx-admin-github', url: 'https://github.com/nitisdev/cortx-re']]])
                }
