...
pipeline { 
    ...
    parameters {  
	    string(name: 'CSM_URL', defaultValue: 'https://github.com/Seagate/cortx-monitor', description: 'Repo for CORTX Monitor')
        string(name: 'CSM_BRANCH', defaultValue: 'main', description: 'Branch for CORTX Monitor')   
	}
    ...
    environment {
        ...
        COMPONENT_NAME = "cortx-monitor".trim()
            ...
            steps {
                ...
                dir("csm") {
                    ...
                    sh label: 'Build', returnStatus: true, script: '''
                        ...
                        ./jenkins/build.sh $VERSION -b $BUILD_NUMBER -t
                    '''
