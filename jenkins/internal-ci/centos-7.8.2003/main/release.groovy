	...
	stages {	
		...
		stage ('Generate Release ISO') {
		    steps {
                ...
                wget -O $integration_dir/$release_tag/prod/iso/install.sh https://raw.githubusercontent.com/Seagate/cortx-prvsnr/$cortx_prvsnr_preq/srv/components/provisioner/scripts/cortx_prep.sh
