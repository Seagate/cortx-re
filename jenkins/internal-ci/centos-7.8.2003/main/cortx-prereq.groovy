    ...
    stages {
        ...
        stage('Checkout') {
            steps {
                ...
                checkout([$class: 'GitSCM', branches: [[name: "${branch}"]], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'PathRestriction', excludedRegions: '', includedRegions: 'scripts/third-party-rpm/.*']], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'shailesh-github', url: 'https://github.com/Seagate/cortx-re']]])
            }
        }
