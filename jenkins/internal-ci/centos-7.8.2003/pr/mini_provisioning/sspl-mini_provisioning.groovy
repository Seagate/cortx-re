        ...
        always {
            script  {
                ...
                if(env.ghprbPullLink){
                    ...
                    env.repo_url = "${SSPL_URL}"
                }
                env.build_stage = "${build_stage}"

                def mailRecipients = "shailesh.vaidya@seagate.com,priyank.p.dalal@seagate.com,chetan.deshmukh@seagate.com,puja.mudaliar@seagate.com,mariyappan.ponnusamy@seagate.com,gowthaman.chinnathambi@seagate.com,mukul.malhotra@seagate.com"
