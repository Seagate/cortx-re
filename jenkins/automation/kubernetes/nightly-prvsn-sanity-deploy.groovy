...
pipeline {
    ...
    parameters {
        ...
        string(name: 'CORTX_SCRIPTS_REPO', defaultValue: 'https://github.com/tanujashinde0405/cortx-k8s', description: 'Repository for cortx-k8s scripts (Services Team)', trim: true)
