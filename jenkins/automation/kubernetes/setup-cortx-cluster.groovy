pipeline {
    ...
    parameters {
        ...
        string(name: 'CORTX_SERVER_IMAGE', defaultValue: 'ghcr.io/seagate/cortx-rgw:2.0.0-664', description: 'CORTX-SERVER image', trim: true)
        ...
        // Please configure EXTERNAL_EXPOSURE_SERVICE, CORTX_SCRIPTS_BRANCH and CORTX_SCRIPTS_REPO parameter in Jenkins job configuration.
