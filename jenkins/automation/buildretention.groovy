		...
		stage ("Build custom-ci") {
					steps {
						...
						parameters: [
								...
								string(name: 'CSM_AGENT_URL', defaultValue: 'https://github.com/balajiramachandran-seagate/cortx-manager', description: 'CSM_AGENT URL')
								string(name: 'CSM_WEB_BRANCH', defaultValue: '${COMMIT_HASH}', description: 'Branch for CSM Web')
								string(name: 'CSM_WEB_URL', defaultValue: 'https://github.com/balajiramachandran-seagate/cortx-management-portal', description: 'CSM WEB URL')
								string(name: 'HARE_BRANCH', defaultValue: '${COMMIT_HASH}', description: 'Branch for Hare')
								string(name: 'HARE_URL', defaultValue: 'https://github.com/balajiramachandran-seagate/cortx-hare', description: 'Hare URL')
								string(name: 'HA_BRANCH', defaultValue: '${COMMIT_HASH}', description: 'Branch for Cortx-HA')
								string(name: 'HA_URL', defaultValue: 'https://github.com/balajiramachandran-seagate/cortx-ha.git', description: 'Cortx-HA URL')
								string(name: 'MOTR_BRANCH', defaultValue: '${COMMIT_HASH}', description: 'Branch for Motr')
								string(name: 'MOTR_URL', defaultValue: 'https://github.com/balajiramachandran-seagate/cortx-motr.git', description: 'Motr URL')
								string(name: 'PRVSNR_BRANCH', defaultValue: '${COMMIT_HASH}', description: 'Branch for Provisioner')
								string(name: 'PRVSNR_URL', defaultValue: 'https://github.com/balajiramachandran-seagate/cortx-prvsnr.git', description: 'Provisioner URL')
								string(name: 'S3_BRANCH', defaultValue: '${COMMIT_HASH}', description: 'Branch for S3Server')
								string(name: 'S3_URL', defaultValue: 'https://github.com/balajiramachandran-seagate/cortx-s3server.git', description: 'S3Server URL')
								string(name: 'SSPL_BRANCH', defaultValue: '${COMMIT_HASH}', description: 'Branch for SSPL')
								string(name: 'SSPL_URL', defaultValue: 'https://github.com/balajiramachandran-seagate/cortx-monitor.git', description: 'SSPL URL')
							]
					}
				}	
	post {
