...
pipeline { 
    ...
    parameters {
        ...
        choice(name: 'MAXIMUM_ALLOWED_TIME_TO_HOLD_NODE', choices: [ 24, 12, 6, 3, 1 ], description: 'Only enable & cleanup the node that was disabled X hours before. FORCE option will ovverride this behaviour')
