                ...
                script {
                    if ( "${UPLOAD_TEST_CONF}" == "yes" ) {
                        ...
                        sh label: 'run compatibility test', script: '''
                            ...
                            sed -i "s#<S3_MAIN_USER_ID>#${S3_MAIN_USER_ID}#;s#<S3_MAIN_ACCESS_KEY>#${S3_MAIN_ACCESS_KEY}#;s#<S3_MAIN_SECRET_KEY>#${S3_MAIN_SECRET_KEY}#g;" ${S3_TEST_CONF_FILE}
        ...
        stage ('Generate Support Bundle ') {
            ...
            steps {
                script {
                    ...
                    sh label: 'build', script: '''
                        echo "Creating support bundle in /tmp" 
