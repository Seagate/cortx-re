	...
	stages {
		...
		stage ('Threshold alert') {
					steps {
						...
						find /mnt/data1/releases/cortx/github/integration-custom-ci/release/centos-7.8.2003/custom-build-394_bkp -path /mnt/data1/releases/cortx/github/integration-custom-ci/release/centos-7.8.2003 -prune -false -o -name '*' -exec cp {} /mnt/data1/releases/backups/cortx_build_backup/custom_build_backup \\;
