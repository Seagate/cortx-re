pipeline {
    ...
    parameters {
        ...
        text(defaultValue: '''hostname=<hostname>,user=<user>,pass=<password>''', description: 'VM details to be used. First node will be used as Primary node. Recommended all nodes with same OS, host OS is automatically detected.', name: 'hosts')
