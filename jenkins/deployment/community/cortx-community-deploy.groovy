        ...
        stage('Setup K8s cluster') {
            steps {
                ...
                pushd solutions/community-deploy/cloud/AWS
                    ...
                    export HOST3=$(cat ec2_hostname.txt | jq '.[2]'| tr -d '",[]')
                    export HOST4=$(cat ec2_hostname.txt | jq '.[3]'| tr -d '",[]')
                    export CORTX_SERVER_IMAGE=ghcr.io/seagate/cortx-rgw:2.0.0-latest
                    export CORTX_DATA_IMAGE=ghcr.io/seagate/cortx-data:2.0.0-latest
                    export CORTX_CONTROL_IMAGE=ghcr.io/seagate/cortx-control:2.0.0-latest
