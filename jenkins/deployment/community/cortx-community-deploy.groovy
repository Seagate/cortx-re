pipeline {
    ...
    parameters {
        ...
        string(name: 'VOLUME_COUNT', defaultValue: '9', description: 'EBS volume count', trim: true)
        string(name: 'VOLUME_SIZE', defaultValue: '10', description: 'EBS volume size in GB', trim: true)
        string(name: 'INSTANCE_COUNT', defaultValue: '4', description: 'EC2 instance count', trim: true)
        string(name: 'INSTANCE_TAG_NAME', defaultValue: 'cortx-multinode', description: 'Tag for EC2 instances', trim: true)
