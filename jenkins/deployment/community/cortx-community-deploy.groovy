            ...
            steps {
                ...
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    if [ "$INSTANCE_COUNT" -eq 1 ]; then
                        ssh -i cortx.pem -o 'StrictHostKeyChecking=no' centos@"${PRIMARY_PUBLIC_IP}" "sudo bash /home/centos/setup.sh && sleep 240;done
                    else
