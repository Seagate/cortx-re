        ...
        stage('EC2 connection prerequisites') {
            steps {
                ...
                pushd solutions/community-deploy/cloud/AWS
                    ...
                    export HOST1=$(cat ec2_hostname.txt | jq '.[0]'| tr -d '",[]') && export HOST2=$(cat ec2_hostname.txt | jq '.[1]'| tr -d '",[]') && export HOST3=$(cat ec2_hostname.txt | jq '.[2]'| tr -d '",[]') && export HOST4=$(cat ec2_hostname.txt | jq '.[3]'| tr -d '",[]')
