...
pipeline { 
    ...
    parameters {
        ...
        choice(name: 'REIMAGE', choices: ["no", "yes" ], description: 'Re-Image option')
    }
        ...
        stage ('Prerequisite') {
            steps {
                script {
                    ...
                    // Clone cortx-re repo
                    dir('cortx-re') {
                        checkout([$class: 'GitSCM', branches: [[name: '*/mini_prov_s3']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'cortx-admin-github', url: 'https://github.com/Seagate/cortx-re']]])                
                    }
                }
            }
        }
